...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.xillybus_wrapper.autotvin_in_r.dat"
         "c.xillybus_wrapper.autotvin_out_r.dat"
         "c.xillybus_wrapper.autotvout_out_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.xillybus_wrapper.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
