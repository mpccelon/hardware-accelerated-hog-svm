...
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado/2018.1/win64/tools/fpo_v7_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "xillybus_wrapper.autotvin.dat"
	set constFileTvOut       "xillybus_wrapper.autotvout.dat"
	set constFileHdlTvIn     "xillybus_wrapper.autohdltvin.dat"
	set constFileHdlTvOut    "xillybus_wrapper.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
