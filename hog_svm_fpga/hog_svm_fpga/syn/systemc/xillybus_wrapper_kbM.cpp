...
void xillybus_wrapper_kbM::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void xillybus_wrapper_kbM::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void xillybus_wrapper_kbM::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void xillybus_wrapper_kbM::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
