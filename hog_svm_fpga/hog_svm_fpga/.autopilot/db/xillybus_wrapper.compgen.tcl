...
set ID 25
set MemName xillybus_wrapper_g8j_memcore
...
set MemName xillybus_wrapper_g8j
...
# Memory (RAM/ROM)  definition:
set ID 26
set MemName xillybus_wrapper_hbi_memcore
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 576
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName xillybus_wrapper_hbi
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# Memory (RAM/ROM)  definition:
set ID 27
set MemName xillybus_wrapper_ibs_memcore
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 64
set AddrRange 64
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName xillybus_wrapper_ibs
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# Memory (RAM/ROM)  definition:
set ID 28
set MemName xillybus_wrapper_jbC_memcore
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 1764
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName xillybus_wrapper_jbC
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# Memory (RAM/ROM)  definition:
set ID 29
set MemName xillybus_wrapper_kbM_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 26
set AddrRange 4096
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName xillybus_wrapper_kbM
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# Memory (RAM/ROM)  definition:
set ID 30
set MemName xillybus_wrapper_lbW_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 4
set AddrRange 4096
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName xillybus_wrapper_lbW
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
