...
HD_PWD='D:/lolic/Documents/Thesis/hardware-accelerated-hog-svm/hog_svm_fpga/hog_svm_fpga/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xillybus_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xillybus_wrapper.tcl
